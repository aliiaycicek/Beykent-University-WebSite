  ...
  return (
    <section className="relative min-h-screen">
      ...
      <div className="relative z-10 flex flex-col min-h-screen">
        ...
        <div className="h-[140px] sm:h-[164px]" />
        ...
        <div className="flex-1 flex items-center">
          <div className="mx-auto w-full max-w-[1440px] px-4 sm:px-6 lg:px-8">
            <div className="max-w-2xl">
              {/* Subtitle */}
              <p className="text-sm sm:text-base font-medium text-white/80 mb-4 animate-fade-in">
                Geleceğin Kapısını Aralayın
              </p>

              {/* Main Title */}
              <h1 className="text-4xl sm:text-5xl lg:text-6xl xl:text-7xl font-bold leading-tight mb-6 animate-slide-up">
              ...
              {/* Description */}
              <p className="text-base sm:text-lg lg:text-xl text-white/90 mb-8 max-w-xl leading-relaxed animate-fade-in-delayed">
          ...
          <div className="mx-auto w-full max-w-[1440px] px-4 sm:px-6 lg:px-8">
            <div className="flex flex-wrap justify-center lg:justify-start gap-8 sm:gap-12 lg:gap-16">
              <div className="text-center lg:text-left">
                <div className="text-3xl sm:text-4xl lg:text-5xl font-bold text-[#FFDD00]">
                  30+
                </div>
                <div className="text-sm text-white/80 mt-1">Yıllık Deneyim</div>
              </div>
              <div className="text-center lg:text-left">
                <div className="text-3xl sm:text-4xl lg:text-5xl font-bold text-[#FFDD00]">
                  50K+
                </div>
                <div className="text-sm text-white/80 mt-1">Mezun</div>
              </div>
              <div className="text-center lg:text-left">
                <div className="text-3xl sm:text-4xl lg:text-5xl font-bold text-[#FFDD00]">
                  100+
                </div>
                <div className="text-sm text-white/80 mt-1">Program</div>
              </div>
              <div className="text-center lg:text-left">
                <div className="text-3xl sm:text-4xl lg:text-5xl font-bold text-[#FFDD00]">
                  4
                </div>
                <div className="text-sm text-white/80 mt-1">Kampüs</div>
              </div>
            </div>
          </div>
        </div>
